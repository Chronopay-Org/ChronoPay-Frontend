...
export function Tooltip({
  ...
  // Resize + scroll: recalculate while visible
  useEffect(() => {
    if (!isVisible) return;
    ...
    return () => {
      ...
      window.removeEventListener("scroll", recalculate, { capture: true } as EventListenerOptions);
    };
  }, [isVisible, recalculate]);

  // Recalculate whenever props change while visible
  useEffect(() => {
