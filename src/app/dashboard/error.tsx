...
export default function DashboardError({
  ...
  return (
    <DashboardShell>
      <section
        role="alert"
        className="glass-panel mx-auto max-w-2xl rounded-4xl p-6 sm:p-8"
      >
        ...
        <div className="mt-6 rounded-3xl border border-rose-300/15 bg-rose-300/10 px-4 py-3 text-sm text-rose-100">
